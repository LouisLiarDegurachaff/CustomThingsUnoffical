...
public class AchievementType extends JsonType {
        ...
        CRAFTING {
            ...
            public boolean matchesObject(Object test, Object... in) {
                ...
                if (obj instanceof String) {
                    ...
                    return i1.getItem() == i2.getItem() && (i1.getItemDamage() == i2.getItemDamage()
                        || i2.getItemDamage() == OreDictionary.WILDCARD_VALUE);
                } else {
                    return false;
                }
            }
        ...
        BLOCK_BREAK {
            ...
            public boolean matchesObject(Object test, Object... in) {
                ...
                if (in[0] instanceof Block && in[1] instanceof Integer) {
                    return Item.getItemFromBlock((Block) in[0]) == block.getItem()
                        && ((Integer) in[1] == block.getItemDamage()
                            || block.getItemDamage() == OreDictionary.WILDCARD_VALUE);
                }
                return false;
            }
        },
                ...
                if (in[0] instanceof EntityLivingBase) {
                    ...
                    if (entityName != null) {
                        return entityName.toLowerCase()
                            .contains(((String) test).toLowerCase());
                    }
                    return in[0].getClass()
                        .getName()
                        .toLowerCase()
                        .contains(((String) test).toLowerCase());
                }
                ...
                if (in[0] == test && in[1] instanceof EntityPlayerMP) {
                    ...
                    for (Achievement a : page.getAchievements()) {
                        if (!file.hasAchievementUnlocked(a) && a != in[2]
                            && (!(a instanceof Ach) || (((Ach) a).parent.achievementSource != this
                                || !((Ach) a).parent.required.equals(page.getName())))) {
                            return false;
                        }
                    }
                    return true;
    ...
    private class Ach extends Achievement {
        ...
        public Ach(String p_i45302_1_, String p_i45302_2_, int p_i45302_3_, int p_i45302_4_, ItemStack p_i45302_5_,
    ...
    public void register() {
        ...
        if (achievementPage != null) {
            ...
            achievementPage.getAchievements()
                .add(achievement);
        } else {
