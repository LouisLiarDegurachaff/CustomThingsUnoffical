...
public class BlockType extends JsonType {
    ...
    public enum BlockShape {
        ...
        public <T extends IBlockCustom> T create(BlockData data) {
            return (T) clazz.getConstructor(BlockData.class)
                .newInstance(data);
        }
        ...
        try {
            ...
            if (ms == null) {
                throw new RuntimeException(
                    type + " is not a valid block type. Valid types are: " + Arrays.toString(MaterialSound.values()),
                    e);
            } else {
                throw new RuntimeException(
                    shape + " is not a valid shape. Value shapes are: " + Arrays.toString(BlockShape.values()),
                    e);
            }
        }
    }
