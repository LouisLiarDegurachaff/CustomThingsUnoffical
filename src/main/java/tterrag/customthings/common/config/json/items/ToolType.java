...
public class ToolType extends ItemType implements IHasMaterial {
    ...
    public enum ToolClass {
        ...
        public String getUnlocName(String base) {
            return base + StringUtils.capitalize(
                this.name()
                    .toLowerCase());
        }
    }
    ...
    private Item instantiate(ToolClass clazz) {
        try {
            return (Item) clazz.itemClass.getDeclaredConstructor(ToolType.class)
                .newInstance(this);
        } catch (NoSuchMethodException e) {
            throw new NoSuchMethodError(
                "Class " + clazz.itemClass.getName() + " must have a constructor that takes a ToolType object");
        } catch (Exception e) {
